...
con = Connection()
con.openConnection()
query = pd.read_sql_query(sql1.ss14c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.ss15c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.ss16c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.ss17c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.ss18c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.ss19c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.ss20c1(), con.connection)
con.closeConnection()
...
con = Connection()
con.openConnection()
query = pd.read_sql_query(sql1.vm14c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.vm15c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.vm16c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.vm17c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.vm18c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.vm19c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.vm20c1(), con.connection)
con.closeConnection()
...
con = Connection()
con.openConnection()
query = pd.read_sql_query(sql1.dc14c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.dc15c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.dc16c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.dc17c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.dc18c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.dc19c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.dc20c1(), con.connection)
con.closeConnection()
...
con = Connection()
con.openConnection()
query = pd.read_sql_query(sql1.mmf14c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.mmf15c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.mmf16c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.mmf17c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.mmf18c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.mmf19c1(), con.connection)
con.closeConnection()
...
con.openConnection()
query = pd.read_sql_query(sql1.mmf20c1(), con.connection)
con.closeConnection()
